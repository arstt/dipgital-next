...
const hero_content = {
  title_1: (
    <>
      Great <span>Businesses</span>
    </>
  ),
  title_2: "Transformation to Digital Start Here.",
  info: (
    <>
      Dipgital offers comprehensive Digital Transformation services, ensuring
      seamless functionality on all devices.
      <br /> Your success, our priority.
    </>
  ),
  btn_1: "Live Damo",
