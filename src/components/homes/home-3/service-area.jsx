...
const service_content = {
   title: <>Crafting Precision <br />Delivering Excellence</>,
   btn_text: <>See All Services</>,

   bg_img: "/assets/img/service/service-3-bg.png",
   service_title: "Point Of Sales",
                     ...
                     {service_data.slice(5, 9).map((item, i)  => 
                        ...
                        <div className="tp-service-sm-item mb-30 d-flex flex-column justify-content-between">
                           ...
                           <div className="tp-service-sm-content">
                              ...
                              <h3 className="tp-service-sm-title"><Link href={item.href}>{item.description} </Link></h3>
                              <div className="tp-service-sm-link">
                                 <Link href={item.href}>Learn More <i className="far fa-arrow-right"></i></Link>
                              </div>
                           </div>
                        </div>
                     </div>
